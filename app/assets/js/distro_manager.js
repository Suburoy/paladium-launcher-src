...
const logger = require('./logger_util')('distromanager');
...
class Module {
    ...
    _resolveMetaData() {
        try {
            ...
            logger.error('Improper ID for module ' + this.identifier + ", " + exception);
        }
    }
    ...
    return new Promise((resolve, reject) => {
        ...
        request(opts, (error, resp, body) => {
            if (!error) {
                ...
                fs.writeFile(DISTRO_PATH, body, 'utf-8', (err) => {
                    if (!err) {
                        resolve(data);
                    }
                    else {
...
exports.pullLocal = function() {
    return new Promise((resolve, reject) => {
        fs.readFile(DISTRO_PATH, 'utf-8', (err, d) => {
            if (!err) {
